...
No Scoop? Install it first, from a normal (non-admin) PowerShell: `irm get.scoop.sh | iex` (needs an execution policy of `RemoteSigned` or looser: `Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope CurrentUser -Force`).
